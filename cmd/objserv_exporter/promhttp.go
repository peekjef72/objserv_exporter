...
func ExporterHandlerFor(exporter objserv_exporter.Exporter) http.Handler {
...
func contextFor(req *http.Request, exporter objserv_exporter.Exporter) (context.Context, context.CancelFunc) {
