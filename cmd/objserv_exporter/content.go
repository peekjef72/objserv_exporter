...
const (
	docsUrl   = "https://github.com/peekjef72/objser_exporter#readme"
	templates = `
    {{ define "page" -}}
      <html>
      <head>
        <title>Prometheus ObjectServer Exporter</title>
        <style type="text/css">
      ...
      <body>
        <div class="navbar">
          <div class="navbar-header"><a href="/">Prometheus ObjectServer Exporter</a></div>
    ...
    {{ define "content.home" -}}
      <p>This is a <a href="{{ .DocsUrl }}">Prometheus ObjectServer Exporter</a> instance.
...
func ConfigHandlerFunc(metricsPath string, exporter objserv_exporter.Exporter) func(http.ResponseWriter, *http.Request) {
	return func(w http.ResponseWriter, r *http.Request) {
